...
/*
 * modified by chiliWang
 * 2014.08.27
 */
ERROR_CODE pc28f128P33_ConfigAsyncModeRCR (float nor_clk, int *latency_count)
{
  ERROR_CODE ErrorCode = NO_ERR;
  uint32_t rcr;
  ...
  rcr = (RM_ASYNC | (*latency_count << BITP_LC) | WP_ACTIVE_HIGH
	 | WD_ONE_DATA_CYCLE | BS_LINEAR | CE_RISING_EDGE | BL_4_WORD);
