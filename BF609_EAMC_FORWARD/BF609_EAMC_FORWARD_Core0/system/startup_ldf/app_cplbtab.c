/*
** ADSP-BF609 CPLB table definitions for coreA generated on Oct 20, 2014 at 09:14:55.
*/
/*
...
cplb_entry dcplbs_table[] = {
   ...
   */
   ...
   /* 
   ** Configuration for 128 MB SDRAM (DDR2), as supplied on the ADSP-BF609 EZ-KIT.
   **
...
cplb_entry icplbs_table[] = {
   ...
   {0x01000000, (ENUM_ICPLB_DATA_16MB | CPLB_INOCACHE)}, 
   {0x02000000, (ENUM_ICPLB_DATA_16MB | CPLB_IDOCACHE)}, 
   {0x03000000, (ENUM_ICPLB_DATA_16MB | CPLB_IDOCACHE)}, 
   {0x04000000, (ENUM_ICPLB_DATA_16MB | CPLB_IDOCACHE)}, 
   {0x05000000, (ENUM_ICPLB_DATA_16MB | CPLB_INOCACHE)}, 
   {0x06000000, (ENUM_ICPLB_DATA_16MB | CPLB_IDOCACHE)}, 
   {0x07000000, (ENUM_ICPLB_DATA_16MB | CPLB_IDOCACHE)}, 
